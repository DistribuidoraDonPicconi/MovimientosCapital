...
// (siempre tienen que pedirse a la red, para no mostrar movimientos
// desactualizados si en algún momento se cae la conexión). El resto del
// cascarón usa "red primero, caché de respaldo" para mantenerlo
// actualizado cuando hay conexión, y sirve desde caché si la red falla
// (offline).
